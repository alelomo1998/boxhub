...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'benchmarks', redirectTo: 'wods' },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'types', title: $localize`:@@route.admin.types:Class types`, loadComponent: () => import('./features/programming/types.page').then(m => m.TypesPage) },
